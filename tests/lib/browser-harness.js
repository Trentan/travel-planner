...
function createBrowserHarness({
  ...
  const baseIds = [
    'activeFileDisplay', 'saveStatus', 'timestampStatus', 'editToggleBtn',
    'undoBtn', 'redoBtn', 'modeToggleBtn', 'saveAsBtn', 'openFileBtn', 'installAppBtn', 'mobileEditToggleBtn',
    'mobileUndoBtn', 'mobileRedoBtn', 'mobileSaveAsBtn', 'mobileOpenFileBtn', 'mobileInstallAppBtn',
  ...
  const accentIds = ['saveAsBtn', 'openFileBtn', 'installAppBtn', 'mobileSaveAsBtn', 'mobileOpenFileBtn', 'mobileInstallAppBtn', 'editToggleBtn', 'undoBtn', 'redoBtn', 'mobileEditToggleBtn', 'mobileUndoBtn', 'mobileRedoBtn'];
...
function loadAppScripts(harness) {
  const scriptOrder = [
    ...
    ['js/leg-engine.js', 'js/leg-engine.js'],
    ['js/leg-dialog.js', 'js/leg-dialog.js'],
    ['js/activity-scheduler.js', 'js/activity-scheduler.js'],
    ['js/activity-modal.js', 'js/activity-modal.js'],
    ['js/stays.js', 'js/stays.js'],
