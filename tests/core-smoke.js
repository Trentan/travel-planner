...
async function run() {
  ...
  assert(toasts.some(t => t.includes('Prompt copied to clipboard')) || alerts.some(a => a.includes('Prompt copied to clipboard')), 'copyPrompt should trigger success toast/alert message');
