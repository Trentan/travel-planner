...
(function() {
  ...
  window.renderTripGalleryGrid = async function() {
    ...
    trips.forEach(trip => {
      ...
      const legCount = trip.legCount !== undefined && trip.legCount !== null ? trip.legCount : 0;
      const stayCount = trip.stayCount !== undefined && trip.stayCount !== null ? trip.stayCount : 0;
