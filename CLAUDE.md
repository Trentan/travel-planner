...
9. In the final response, include direct clickable links to the before image, proposal image, and after image for immediate review.
...
8. Include direct clickable links to the before image, proposal image, and after image in the completion response.
