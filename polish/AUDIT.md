...
**Tracker sync:** 25/32 complete, 0 in Review, 6 active backlog rows.

---

## Critical Items

1. **[WI-029] Touch-Friendly Suggested Activity Assignment.** Status: Todo. Drag-and-drop is unusable on mobile. Implement a tap-to-assign flow.
