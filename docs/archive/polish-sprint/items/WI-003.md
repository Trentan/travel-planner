...
| Proposal image | [items/proposals/WI-003-proposal.png](./proposals/WI-003-proposal.png) |
| Actual after screenshot | [screenshots/after/WI-003-after.png](../screenshots/after/WI-003-after.png) (captured 2026-05-16) |
...
All journey fields fit within the viewport. The footer buttons wrap safely, and the Save journey button is fully visible without horizontal scrolling.

## Acceptance criteria

- [x] No horizontal overflow in `#journey-modal` at 390px.
- [x] Save journey, Add segment, Delete, and Cancel are fully visible and tappable.
