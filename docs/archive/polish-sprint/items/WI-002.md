...
| Proposal image | [items/proposals/WI-002-proposal.png](./proposals/WI-002-proposal.png) |
| Actual after screenshot | [screenshots/after/WI-002-after.png](../screenshots/after/WI-002-after.png) |
| Files to change | `style.css` Â· `index.html` Â· `js/ui.js` |
...
[WI-002 after](../screenshots/after/WI-002-after.png)

## Acceptance criteria

- [x] `.app-menu-bar` height is no more than 72px at 390px.
- [x] Disabled undo/redo controls do not render as empty pills on mobile.
